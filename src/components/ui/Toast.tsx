...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Action
    ...
    className={cn(
      ...
      'group-[.destructive]:border-red-200 group-[.destructive]:hover:border-red-300 group-[.destructive]:hover:bg-red-100 group-[.destructive]:focus:ring-red-400',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ...
    className={cn(
      ...
      'group-[.destructive]:text-red-500 group-[.destructive]:hover:text-red-600',
      className
    )}
    toast-close=""
    {...props}

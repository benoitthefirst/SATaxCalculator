        ...
        <div className="md:col-span-2">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input
              ...
              placeholder="Search description, source, invoice..."
              className="flex-1 px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#34C759]/20 focus:border-[#34C759] transition-all"
            />
            <button
              type="submit"
